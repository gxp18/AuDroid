...
#include <media/AudioSystem.h> //gxp18
                                          ...
                                          audio_input_flags_t flags)
{
   ...
   callerPIDGXP18 = pid;
    __android_log_print(ANDROID_LOG_DEBUG,"gxp18 - Mutex", "AudioFlinger OpenInput CallerPID %d UID %d ID %d", pid, uid, callerPIDGXP18);
    // end
...
status_t AudioFlinger::closeInput(audio_io_handle_t input)
{
    ...
    pid_t pid = IPCThreadState::self()->getCallingPid();
    int uid = IPCThreadState::self()->getCallingUid();
    __android_log_print(ANDROID_LOG_DEBUG,"gxp18 - Mutex", "AudioFlinger CloseInput CallerPID %d UID %d ID %d", pid, uid, callerPIDGXP18);
    // end
